...
const Readings = {
  BibleIntroFR: "",
  BibleIntroAR:
    "قفوا بخوف أمام الله لنسمع الإنجيل المقدس، فصل من بشارة الإنجيل لمعلمنا مار ــــــــــ البشير، والتلميذ الطاهر، بركاته على جميعنا",
  GospelEndFR: "",
  GospelEndAR: "",
  ...
  KatholikonEndFR: "",
  KatholikonEndAR:
    "لا تحبو العالم ولا الأشياء التي في العالم لأن العالم يمضي وشهوته معه أما من يصنع مشيئة الله فيثبت إلى الأبد",
  Praxis: "ReadingsPraxis",
  PraxisIntroFR: "",
  PraxisIntroAR:
    "الإبركسيس فصل من أعمال آبائنا الرسل الأطهار، الحوارين، المشمولين بنعمة الروح القدس، بركتهم المقدسة فلتكن معكم يا آبائي واخوتي آمين",
  PraxisEndFR: "",
  PraxisEndAR:
    "لم تزل كلمة الرب تنمو وتعتز وتكثر في هذا البيعة وكل بيعة يا آبائي وإخوتي آمين",
...
const BaptizedMassPrayers = [
  CommonPrayers.LitanyOfPeace,
  CommonPrayers.LitanytoTheFathers,
  CommonPrayers.LitanyOfTheAssemblies,
  CommonPrayers.Creed,
  "PrayerOfReconciliation",
  "Anaphora",
  "Agios",
  ...
  "LitanyOfEkliros",
  "LitanyOfThePlace",
  "LitanyOfTheSeedsAndHerbs",
  "LitanyOfTheOblations",
  "CommemorationOfTheSaints",
  "IntroductionToTheFraction",
  "FractionPrayer",
  CommonPrayers.OurFather,
  "PriestConfession",
  "DeaconConfession",
  "Communinon",
];
